# 1 "serial.c"
# 1 "/home/akv/aj1/drive-download-20170523T182400Z-001/SerialCommunication_1//"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 42 "/usr/include/x86_64-linux-gnu/sys/ipc.h" 3 4
...
Sensordata_t *Sensordata_SHM_Addr = (Sensordata_t *)
# 56 "serial.c" 3 4
                                                   ((void *)0)
# 56 "serial.c"
                                                       ;
...
# 143 "serial.c"
     ...
     Sensordata_SHM_Addr = (Sensordata_t *)shmat( SHMID , 
# 154 "serial.c" 3 4
                                                         ((void *)0) 
# 154 "serial.c"
                                                              ,0);
...
# 171 "serial.c"
        ...
        {
            SEMID = semget( (key_t)3344 , 1 , 0666 );
        }
       else
        {
...
sint MQ_Init(void)
 {
      if( ( MessageQueue_ID = msgget( (key_t)4455 , 0666|
# 196 "serial.c" 3 4
                                                          01000 
# 196 "serial.c"
                                                                    ) ) < 0 )
...
# 208 "serial.c"
    ...
    {
          perror("Unable to open UARt port:UART_Init:UARTPROCESS"); close(UART_fd);return -1;
    }
    tcgetattr( UART_fd , &TerminalSettings );
    cfsetospeed( &TerminalSettings, 
# 213 "serial.c" 3 4
                                   0000015 
# 213 "serial.c"
                                         );
       cfsetispeed( &TerminalSettings, 
# 214 "serial.c" 3 4
                                      0000015 
# 214 "serial.c"
                                            );
    TerminalSettings.c_cflag |= (
# 215 "serial.c" 3 4
                                 0004000 
# 215 "serial.c"
                                        | 
...
# 231 "serial.c"
    ...
    if( tcsetattr( UART_fd , 
# 239 "serial.c" 3 4
                            0
# 239 "serial.c"
                                   , &TerminalSettings ) < 0 )
    {
           perror("Unable to set UART attribute:UART_Init:UARTPROCESS"); close(UART_fd); return -1;
    }
    return 0;
 }
